...
The TxMCCS scraper detected changes!
...
Check the repository for history:
https://github.com/Aaylen/tesla/blob/main/data.json`,
  };
...
async function scrape() {
  ...
  if (hasChanged) {
    ...
    // Commit and Push back to Git if running under GitHub Actions
    if (isGithubAction) {
      try {
